...
template <class Listener>
inline const std::string& OpticksCfg<Listener>::getG4RunMac()
{
    return m_g4runmac ;
}
template <class Listener>
inline const std::string& OpticksCfg<Listener>::getG4FinMac()
{
    return m_g4finmac ;
}
...
template <class Listener>
inline int OpticksCfg<Listener>::getInterpolatedViewPeriod()
{
    return m_ivperiod ; 
}
...
template <class Listener>
inline int OpticksCfg<Listener>::getTrackViewPeriod()
{
    return m_tvperiod ; 
}
template <class Listener>
inline int OpticksCfg<Listener>::getAnimatorPeriod()
{
