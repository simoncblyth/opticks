...
* CONSIDER REJIG TO ALLOW 8-PARAM : OR USE PLANE REFERENCING FOR EXTRA PARAM

  * boundary and typecode are small, they could easily be colocated
  * simliarly index, gtransformIdx, complement could be combined
...
* vim replace : shift-R
    ...
    |    | sl:a           | sl:b           |  (1,2)         | (within solid) |  sl:a,b offsets from origin                     |
