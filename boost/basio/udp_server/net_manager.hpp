...
public:
   ...
   net_manager(Delegate* delegate, unsigned int udp_port, const char* zmq_backend)
       : 
       m_local_io_service(),
       ...
       m_udp_server(m_local_io_service, delegate, udp_port),
       m_npy_server(m_local_io_service, delegate, zmq_backend)
    {
