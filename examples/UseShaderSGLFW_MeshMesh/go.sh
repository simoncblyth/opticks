#!/bin/bash -l
usage(){ cat << EOU
examples/UseShaderSGLFW_MeshMesh/go.sh
=====================================

Started from examples/UseShaderSGLFW_Mesh. 
Are aiming to encapsulate mesh handling to make scalable to 
full scenes with multiple meshes::

    ~/o/examples/UseShaderSGLFW_MeshMesh/go.sh 
    ~/o/examples/UseShaderSGLFW_MeshMesh/go.sh info
    ~/o/examples/UseShaderSGLFW_MeshMesh/go.sh run
