...
ckm-run-bouncemax-zero(){ G4OPTICKS_DEBUG="--bouncemax 0" ckm-run ; }
...
ckm-gentest
    CCerenkovGeneratorTest loads direct gensteps from the geocache keydir 
    identified by the OPTICKS_KEY envvar and generates photons from them.  
