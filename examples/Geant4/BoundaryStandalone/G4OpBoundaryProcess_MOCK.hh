...
//
//
// $Id: G4OpBoundaryProcess_MOCK.hh 104458 2017-05-31 15:54:11Z gcosmo $
//
// 
////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////
//
// File:        G4OpBoundaryProcess_MOCK.hh
...
#ifndef G4OpBoundaryProcess_MOCK_h
#define G4OpBoundaryProcess_MOCK_h 1
...
enum G4OpBoundaryProcess_MOCKStatus {  Undefined,
...
public:
        ...
        G4OpBoundaryProcess_MOCK(const G4String& processName = "OpBoundary",
                                     G4ProcessType type = fOptical);
        ~G4OpBoundaryProcess_MOCK();

private:

        G4OpBoundaryProcess_MOCK(const G4OpBoundaryProcess_MOCK &right);
...
public:
	...
	////////////
        ...
        G4OpBoundaryProcess_MOCKStatus GetStatus() const;
...
private:
        ...
        G4OpBoundaryProcess_MOCKStatus theStatus;
...
inline
G4bool G4OpBoundaryProcess_MOCK::G4BooleanRand(const G4double prob) const
{
...
inline
G4bool G4OpBoundaryProcess_MOCK::IsApplicable(const G4ParticleDefinition& 
                                                       aParticleType)
{
...
inline
G4OpBoundaryProcess_MOCKStatus G4OpBoundaryProcess_MOCK::GetStatus() const
{
   return theStatus;
}

inline
void G4OpBoundaryProcess_MOCK::SetInvokeSD(G4bool flag)
{
  fInvokeSD = flag;
}

inline
void G4OpBoundaryProcess_MOCK::ChooseReflection()
{
...
inline
void G4OpBoundaryProcess_MOCK::DoAbsorption()
{
