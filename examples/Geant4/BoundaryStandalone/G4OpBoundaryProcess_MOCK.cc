...
////////////////////////////////////////////////////////////////////////
//
// File:        G4OpBoundaryProcess_MOCK.cc
...
// G4OpBoundaryProcess_MOCK::operator=(const G4OpBoundaryProcess_MOCK &right)
// {
// }
...
G4OpBoundaryProcess_MOCK::G4OpBoundaryProcess_MOCK(const G4String& processName,
                                               G4ProcessType type)
...
// G4OpBoundaryProcess_MOCK::G4OpBoundaryProcess_MOCK(const G4OpBoundaryProcess_MOCK &right)
// {
// }
...
G4OpBoundaryProcess_MOCK::~G4OpBoundaryProcess_MOCK(){}
...
G4VParticleChange*
G4OpBoundaryProcess_MOCK::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep)
{
        theStatus = Undefined;
...
#ifdef MOCK
        theGlobalNormal = theGlobalNormal_MOCK ; 
        valid = true ;  
#else
        ...
        else 
        {
          ...
          ed << " G4OpBoundaryProcess_MOCK/PostStepDoIt(): "
                 << " The Navigator reports that it returned an invalid normal"
                 << G4endl;
          G4Exception("G4OpBoundaryProcess_MOCK::PostStepDoIt", "OpBoun01",
        ...
        if (OldMomentum * theGlobalNormal > 0.0) {
           ...
           ed << G4endl;
           G4Exception("G4OpBoundaryProcess_MOCK::PostStepDoIt", "OpBoun02",
...
void G4OpBoundaryProcess_MOCK::BoundaryProcessVerbose() const
{
...
G4ThreeVector
G4OpBoundaryProcess_MOCK::GetFacetNormal(const G4ThreeVector& Momentum,
...
void G4OpBoundaryProcess_MOCK::DielectricMetal()
{
        G4int n = 0;
...
void G4OpBoundaryProcess_MOCK::DielectricLUT()
{
        ...
        theStatus = G4OpBoundaryProcess_MOCKStatus(G4int(theFinish) + 
...
void G4OpBoundaryProcess_MOCK::DielectricLUTDAVIS()
{
...
void G4OpBoundaryProcess_MOCK::DielectricDichroic()
{
        // Calculate Angle between Normal and Photon Momentum
...
//                   << std::floor(theTransmittance/perCent) << "%" << G4endl;
           ...
           G4ExceptionDescription ed;
           ed << " G4OpBoundaryProcess_MOCK/DielectricDichroic(): "
              << " The dichroic surface has no G4Physics2DVector"
              << G4endl;
           G4Exception("G4OpBoundaryProcess_MOCK::DielectricDichroic", "OpBoun03",
                       FatalException,ed,
...
void G4OpBoundaryProcess_MOCK::DielectricDielectric()
{
        G4bool Inside = false;
        G4bool Swap = false;
...
// ---------------
//
G4double G4OpBoundaryProcess_MOCK::GetMeanFreePath(const G4Track& ,
                                              G4double ,
...
G4double G4OpBoundaryProcess_MOCK::GetIncidentAngle() 
{
...
G4double G4OpBoundaryProcess_MOCK::GetReflectivity(G4double E1_perp,
                                              G4double E1_parl,
...
void G4OpBoundaryProcess_MOCK::CalculateReflectivity()
{
  G4double RealRindex =
...
G4bool G4OpBoundaryProcess_MOCK::InvokeSD(const G4Step* pStep)
{
  G4Step aStep = *pStep;
