#!/bin/bash
usage(){ cat << EOU
examples/UseShaderSGLFW_SScene_encapsulated/go.sh
====================================================

Started from examples/UseShaderSGLFW_SScene
...
::
    ...
    ~/o/examples/UseShaderSGLFW_SScene_encapsulated/go.sh info
    ~/o/examples/UseShaderSGLFW_SScene_encapsulated/go.sh run

Impl::

    ~/o/examples/UseShaderSGLFW_SScene_encapsulated/UseShaderSGLFW_SScene_encapsulated.cc
