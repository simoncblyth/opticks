...
void Engine::createModule()
{
    ...
    //Engine& engine = *this ;    // macro expects engine in context 
...
void Engine::createProgramGroups()
{
...
int main(int argc, char** argv)
{
    ...
    engine.createShaderBindingTable();
