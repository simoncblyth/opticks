...
This was formerly names UseOptiX. However because it 
is generally useful it needs to be always available. Hence
UseOptiX is relocated into optixrap/tests/UseOptiX.cc
where it will always be built. Unlike this example
with is optional.
