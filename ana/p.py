...
#1,3
iindex_ = lambda p:p.view(np.uint32)[...,1,3] & 0x7fffffff
orient___  = lambda p:p.view(np.uint32)[...,1,3] >> 31
orient_   = lambda p:p.view(np.uint32)[1,3] >> 31


#3,2
idx_      = lambda p:p.view(np.uint32)[3,2]
