...
if __name__ == '__main__':
    ...
    args = opticks_main(doc=__doc__, tag="1", src="torch", det="concentric", c2max=2.0, tagoffset=0,  dbgseqhis=0, dbgmskhis=0, lmx=20, prohis=False, promat=False, dbgzero=False, cmx=0)
