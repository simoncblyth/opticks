#pragma once
/**
SEvt.hh : naming array components of Opticks Event 
=============================================================
...
inline bool SEvt::StartsWith( const char* s, const char* q)  // static
{
    return s && q && strlen(q) <= strlen(s) && strncmp(s, q, strlen(q)) == 0 ; 
}

inline unsigned    SEvt::Component(const char* name)
{
...
inline const char* SEvt::Name(unsigned comp)
{
