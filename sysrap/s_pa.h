...
Q: Could the number of param be increased slightly ? eg for CutCylinder ?
A: Possibly could manage two more param (ie total of 8) by bitwise combination
   of two fields in CSGNode. An alternative way would be to reference planes of 4 param
   each to give unlimited additional params.
