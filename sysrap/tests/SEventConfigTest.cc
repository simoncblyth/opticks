...
struct SEventConfigTest
{
    ...
    static int Initialize_Comp_Simulate_();
...
int SEventConfigTest::Initialize_Comp_Simulate_()
{
    unsigned gather_mask = 0 ;
    unsigned save_mask = 0 ;

    SEventConfig::Initialize_Comp_Simulate_(gather_mask,save_mask );
...
int SEventConfigTest::main()
{
    ...
    if(ALL||strcmp(TEST,"Initialize_Comp_Simulate_") == 0) rc += Initialize_Comp_Simulate_();
