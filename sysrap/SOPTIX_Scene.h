...
/**
SOPTIX_Scene::getHandle
--------------------------

Returns traversable handle that identifies the top of the
geometry to OptiX. Default of -1 corresponds to the IAS
which is the full geometry.
