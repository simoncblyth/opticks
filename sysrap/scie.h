...
The function name suffixes refers to the "CIE 1931 Standard Colorimetric Observer"
which are the fundamental color matching functions (CMFs) defined by
the Commission Internationale de l'Éclairage (CIE) in 1931.

See also::

   sysrap/gl/util/wavelengthToSRGB.glsl
   ana/cie_xyz.py
   g4cx/tests/G4CXTest_raindrop_rainbow.py
...
inline SCIE_METHOD float scie::xFit_1931( float wave )
{
...
inline SCIE_METHOD float scie::yFit_1931( float wave )
{
...
inline SCIE_METHOD float scie::zFit_1931( float wave )
{
...
inline SCIE_METHOD float3 scie::xyzFit_1931(float wave)
{
