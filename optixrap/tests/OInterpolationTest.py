...
if __name__ == '__main__':
    ...
    o = np.load(os.path.expandvars("$TMP/InterpolationTest/OInterpolationTest.npy")).reshape(-1,4,2,39,4) 
    c = np.load(os.path.expandvars("$TMP/InterpolationTest/CInterpolationTest.npy")).reshape(-1,4,2,39,4) 
    assert np.all(t == o)
