...
//
//
// $Id: G4Cerenkov1042.hh 108508 2018-02-15 15:54:35Z gcosmo $
//
// 
////////////////////////////////////////////////////////////////////////
...
#ifndef G4Cerenkov1042_h
#define G4Cerenkov1042_h 1
...
class G4Cerenkov1042 : public G4VProcess
{
...
public:
  ...
  explicit G4Cerenkov1042(const G4String& processName = "Cerenkov", 
             G4ProcessType type = fElectromagnetic);
  ~G4Cerenkov1042();

  explicit G4Cerenkov1042(const G4Cerenkov1042 &right);
...
private:
  ...
  G4Cerenkov1042& operator=(const G4Cerenkov1042 &right) = delete;
...
inline
G4bool G4Cerenkov1042::GetTrackSecondariesFirst() const
{
  return fTrackSecondariesFirst;
}

inline
G4double G4Cerenkov1042::GetMaxBetaChangePerStep() const
{
  return fMaxBetaChange;
}

inline
G4int G4Cerenkov1042::GetMaxNumPhotonsPerStep() const
{
  return fMaxPhotons;
}

inline
void G4Cerenkov1042::SetStackPhotons(const G4bool stackingFlag)
{
        fStackingFlag = stackingFlag;
}

inline
G4bool G4Cerenkov1042::GetStackPhotons() const
{
        return fStackingFlag;
}

inline
G4int G4Cerenkov1042::GetNumPhotons() const
{
        return fNumPhotons;
}

inline
G4PhysicsTable* G4Cerenkov1042::GetPhysicsTable() const
{
  return thePhysicsTable;
}

#endif /* G4Cerenkov1042_h */
