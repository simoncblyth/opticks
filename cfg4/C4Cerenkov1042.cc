...
//
//
// $Id: C4Cerenkov1042.cc 108508 2018-02-15 15:54:35Z gcosmo $
//
////////////////////////////////////////////////////////////////////////
// Cerenkov Radiation Class Implementation
////////////////////////////////////////////////////////////////////////
//
// File:        C4Cerenkov1042.cc
...
//G4bool C4Cerenkov1042::fTrackSecondariesFirst = false;
//G4double C4Cerenkov1042::fMaxBetaChange = 0.;
//G4int C4Cerenkov1042::fMaxPhotons = 0;

  //////////////
  // Operators
  //////////////

// C4Cerenkov1042::operator=(const C4Cerenkov1042 &right)
// {
// }
...
C4Cerenkov1042::C4Cerenkov1042(const G4String& processName, G4ProcessType type)
...
// C4Cerenkov1042::C4Cerenkov1042(const C4Cerenkov1042 &right)
// {
// }
...
G4bool C4Cerenkov1042::IsApplicable(const G4ParticleDefinition& aParticleType)
{
  G4bool result = false;
...
void C4Cerenkov1042::SetTrackSecondariesFirst(const G4bool state)
{
  fTrackSecondariesFirst = state;
}

void C4Cerenkov1042::SetMaxBetaChangePerStep(const G4double value)
{
  fMaxBetaChange = value*CLHEP::perCent;
}

void C4Cerenkov1042::SetMaxNumPhotonsPerStep(const G4int NumPhotons)
{
  fMaxPhotons = NumPhotons;
}

void C4Cerenkov1042::BuildPhysicsTable(const G4ParticleDefinition&)
{
...
//
G4VParticleChange*
C4Cerenkov1042::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep)
...

{
  ...
  G4double MeanNumberOfPhotons2 =
    ...
    // normally the below photon loop would be skipped whilst using Opticks 
    // keeping it now though whilst debugging 
#endif
...
void C4Cerenkov1042::BuildThePhysicsTable()
{
      ...
      if (aMaterialPropertiesTable) {
         ...
         if (theRefractionIndexVector) {
            ...
            if (currentRI > 1.0) {
               ...
               aMaterialPropertyVector->InsertValues(currentPM , currentCAI);
...
G4double C4Cerenkov1042::GetMeanFreePath(const G4Track&,
                                           G4double,
                                           G4ForceCondition*)
{
  return 1.;
...
G4double C4Cerenkov1042::PostStepGetPhysicalInteractionLength(
...
G4double
  C4Cerenkov1042::GetAverageNumberOfPhotons(const G4double charge,
                                        const G4double beta, 
...
void C4Cerenkov1042::DumpPhysicsTable() const
{
