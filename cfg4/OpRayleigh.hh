...
private:
        ...
        OpRayleigh(const OpRayleigh &right);
...
inline
G4bool OpRayleigh::IsApplicable(const G4ParticleDefinition& aParticleType)
{
  return ( &aParticleType == G4OpticalPhoton::OpticalPhoton() );
}

inline
void OpRayleigh::DumpPhysicsTable() const
...
inline G4PhysicsTable* OpRayleigh::GetPhysicsTable() const
{
