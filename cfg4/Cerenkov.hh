...
class CFG4_API Cerenkov : public G4VProcess
{
...
inline
G4bool Cerenkov::GetTrackSecondariesFirst() const
{
        return fTrackSecondariesFirst;
}

inline
G4double Cerenkov::GetMaxBetaChangePerStep() const
{
        return fMaxBetaChange;
}

inline
G4int Cerenkov::GetMaxNumPhotonsPerStep() const
{
        return fMaxPhotons;
}
