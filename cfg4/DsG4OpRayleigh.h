...
#ifndef DsG4OpRayleigh_h
#define DsG4OpRayleigh_h 1
...
class DsG4OpRayleigh : public G4VDiscreteProcess 
{
...
public: // Without description
        ...
        DsG4OpRayleigh(const G4String& processName = "OpRayleigh",
...
inline
G4bool DsG4OpRayleigh::IsApplicable(const G4ParticleDefinition& aParticleType)
{
  return ( &aParticleType == G4OpticalPhoton::OpticalPhoton() );
}

inline
void DsG4OpRayleigh::DumpPhysicsTable() const
...
inline G4PhysicsTable* DsG4OpRayleigh::GetPhysicsTable() const
{
  return thePhysicsTable;
}


#endif /* DsG4OpRayleigh_h */
