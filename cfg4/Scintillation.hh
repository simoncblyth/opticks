...
private:
        ...
        Scintillation(const Scintillation &right);
...
public:
        ...
        // Scintillation Process has both PostStepDoIt (for energy 
	...
	G4VParticleChange* PostStepDoIt(const G4Track& aTrack, 
        ...
        // If set, the Scintillation process expects the user to have
