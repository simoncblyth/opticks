#pragma once
/**
U4OpticalSurfaceModel.h : string consts for G4OpticalSurfaceModel   { glisur, unified, ... }
=================================================================================================
...
inline const char* U4OpticalSurfaceModel::Name(unsigned model)
{
...
inline unsigned U4OpticalSurfaceModel::Model(const char* name)
{
    assert(name); 
