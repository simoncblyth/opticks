...
if __name__ == '__main__':
    ...
    # TODO: avoid repetition with U4Debug class
    ...
    if zero:
        ...
        f00g = f00.gsl.reshape(-1,4) 
        print("f00c %10s f00s %10s f00h %10s f00g %10s " % (str(f00c.shape), str(f00s.shape), str(f00h.shape), str(f00g.shape)) )
        ...
        f01g = f01.gsl.reshape(-1,4) 
        print("f01c %10s f01s %10s f01h %10s f01g %10s " % (str(f01c.shape), str(f01s.shape), str(f01h.shape), str(f01g.shape)) )
    pass
    ...
    if three:
        ...
        f30g = f30.gsl.reshape(-1,4) 
        print("f30c %10s f30s %10s f30h %10s f30g %10s " % (str(f30c.shape), str(f30s.shape), str(f30h.shape), str(f30g.shape)) )
        ...
        f31g = f31.gsl.reshape(-1,4) 

        print("f31c %10s f31s %10s f31h %10s f31g %10s " % (str(f31c.shape), str(f31s.shape), str(f31h.shape), str(f31g.shape)) )
    pass
