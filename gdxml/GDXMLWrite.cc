...
GDXMLWrite::~GDXMLWrite()
{
}

xercesc::DOMElement* GDXMLWrite::NewElement(const char* tagname)
{
...
xercesc::DOMAttr* GDXMLWrite::NewAttribute(const char* name, const char* value)
{
...
std::string GDXMLWrite::ConstantToMatrixValues(double value, double nm_lo, double nm_hi ) 
{
...
xercesc::DOMElement* GDXMLWrite::ConstantToMatrixElement(const char* name, double value, double nm_lo, double nm_hi )
{
...
void GDXMLWrite::write(const char* path)
{
    LOG(LEVEL) << path ; 
   ...
   catch (const xercesc::XMLException& toCatch)
   {
      ...
      std::cout << "GDXMLWrite: Exception message is: " << message << std::endl;
   ...
   {
      std::cout << "GDXMLWrite: Unexpected Exception!" << std::endl;
      return ;
   }
