...
1. include full relative paths
2. include ENV.bash
3. include the Opticks-vLatest symbolic link within the tarball (like junosw/.gitlab-ci/oj_helper.sh:make_tar does)
4. make name include the full slug (again like junosw/.gitlab-ci/oj_helper.sh:make_tar)
