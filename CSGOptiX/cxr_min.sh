...
vv="bin which_bin GEOM MOI MOI_NOTE EMM ELV ELV_NAME ELV_BRANCH TMIN VUE EYE LOOK UP ZOOM LOGDIR BASE PBAS NAMEPREFIX OPTICKS_HASH TOPLINE BOTLINE CUDA_VISIBLE_DEVICES"
