...
void test_overlap()
{
...

    {
        ...
        nbox* _a = nbox::Create(0.f,0.f,0.f,1.f, CSG_BOX);      
        _a->pdump("_a");

        nbbox a = _a->bbox();
        a.dump("a");

        nbox* _b = nbox::Create(3.f,3.f,3.f,1.f, CSG_BOX);      
        _b->pdump("_b");
...

    {
        ...
        nbox* _b = nbox::Create(2.f,2.f,2.f,1.f, CSG_BOX);      
        _b->pdump("_b");
...

    {
        ...
        nbox* _b = nbox::Create(0.5f,0.5f,0.5f,0.5f, CSG_BOX);      
        _b->pdump("_b");
...

    {
        ...
        nbox* _b = nbox::Create(0.5f,0.5f,0.5f,1.f, CSG_BOX);      
        _b->pdump("_b");
...
*/
    ...
    nbox* a = nbox::Create(0.f,0.f,0.f,10.f , CSG_BOX);   a->label = "A" ;     
    nbox* b = nbox::Create(5.f,0.f,0.f,0.01f, CSG_BOX);    b->label = "B" ;   
    nbox* c = nbox::Create(0.f,5.f,0.f,0.01f, CSG_BOX);    c->label = "C" ;   
    nbox* d = nbox::Create(0.f,0.f,5.f,0.01f, CSG_BOX);    d->label = "D" ;     
...
void test_difference_bbox()
{
    ...
    ncylinder* a = ncylinder::Create( radius     , z1, z2);   a->label = "A" ;     
    ncylinder* b = ncylinder::Create( radius-1.f , z1, z2);   b->label = "B" ;   
...
{
    ncylinder* a = ncylinder::Create( rmax , zmin, zmax);   a->label = "A" ;     
    ncylinder* b = ncylinder::Create( rmin , zmin, zmax);   b->label = "B" ;   
...
void test_difference_chop_bbox()
{
    ...
    nbox* a = nbox::Create( 50000.000,50000.000,50000.000,0.000, CSG_BOX3 ) ; a->label = "a" ;   
    nbox* b = nbox::Create( 50010.000,50010.000,12010.000,0.000, CSG_BOX3 ) ; b->label = "b" ;   
