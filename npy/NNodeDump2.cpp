...
NNodeDump2::NNodeDump2(const nnode* node)
   :
   m_node(node)
{
}
...
void NNodeDump2::dump() const 
{
    ...
    {
        LOG(info) << "NNodeDump2::dump verbosity " << m_node->verbosity ;         
        dump_prim();
        dump_transform();
        dump_planes();
    }
...
void NNodeDump2::dump_label(const char* pfx) const 
{
    std::cout 
         << std::setw(3) << (  pfx ? pfx : "-" ) << " " 
...
void NNodeDump2::dump_base() const 
{
    dump_label("du") ; 
...
void NNodeDump2::dump_gtransform() const 
{
    dump_label("gt") ; 
...
void NNodeDump2::dump_transform() const 
{
    dump_label("tr") ; 
...
void NNodeDump2::dump_prim() const 
{
    dump_label("pr") ; 
...
void NNodeDump2::dump_planes() const 
{
    dump_label("pl") ; 
