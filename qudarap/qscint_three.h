...
struct qscint_three
{
    ...
    QSCINT_METHOD float   wavelength_hd20(int species_idx, const float& u0) const ;
#endif
...
#if defined(__CUDACC__) || defined(__CUDABE__) || defined(MOCK_CURAND) || defined(MOCK_CUDA)
inline QSCINT_METHOD float qscint_three::wavelength_hd20(int species_idx, const float& u0) const
{
