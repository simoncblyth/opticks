...
void test_setGenstep_loaded(const NP* gs)
{
    QEvent* event = new QEvent ; 
    event->setGenstep(gs); 
...
int main(int argc, char** argv)
{
    ...
    /*
    test_setGenstep_one(); 
    test_setGenstep_many(); 
    test_setGenstep_loaded(); 
    test_setGenstep_checkEvt(); 
    */

    test_setGenstep_quad6(); 
